...
import json
import requests
import Batch_AudioRead

class Batch_AudioDatasetRead(FlokAlgorithmLocal):
    def run(self,inputDataSets,params,globals):
        ...
        # 调用Batch_AudioRead类中run的函数。
        # 返回DataFrame
        algorithm=Batch_AudioRead.Batch_AudioRead()
...
if __name__ == "__main__":
    ...
    algorithm = Batch_AudioDatasetRead()

...
import json
import requests
import Batch_TextRead

class Batch_TextDatasetRead(FlokAlgorithmLocal):
    def run(self,inputDataSets,params,globals):
        ...
        # 调用Batch_TextRead类中run的函数。
        # 返回DataFrame
        algorithm=Batch_TextRead.Batch_TextRead()
...
if __name__ == "__main__":
    ...
    algorithm = Batch_TextDatasetRead()

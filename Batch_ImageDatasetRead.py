...
import json
import requests
import Batch_ImageRead

class Batch_ImageDatasetRead(FlokAlgorithmLocal):
    def run(self,inputDataSets,params,globals):
        ...
        # 调用Batch_ImageRead类中run的函数。
        # 返回DataFrame
        algorithm=Batch_ImageRead.Batch_ImageRead()
...
if __name__ == "__main__":
    ...
    algorithm = Batch_ImageDatasetRead()
